...
$sql = "SELECT t.name as task_name, t.date, t.completed,t.file, t.project_id, p.name as project_name, p.id FROM `tasks` t JOIN `projects` p ON t.project_id = p.id WHERE t.user_id=$user_id ";
$result = mysqli_query($con, $sql);
if (!$result) {
    $error = mysqli_error($con);
    print("Ошибка MYSQL" . $error);
            ...
            <div class="main-header__side">
                ...
                <div class="main-header__side-item user-menu">
                    <div class="user-menu__data">
                        <p><?php echo $user_active['login'] ?></p>
